defmodule TremtecWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TremtecWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TremtecWeb.Gettext, "errors", msg, opts)
    end
  end
