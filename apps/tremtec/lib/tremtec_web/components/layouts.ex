defmodule TremtecWeb.Layouts do
  ...
  attr :current_path, :string,
    default: "",
    doc: "the current request path for nav highlighting"
  ...
  def app(assigns) do
    ...
    <!-- Admin Mobile Nav -->
      <.admin_nav_mobile :if={@is_admin} current_path={@current_path} />
  ...
  def logo(assigns) do
    ...
    <a href="/" class="flex items-center gap-2">
      <img src={~p"/images/dynamic/logo-128-128.png"} width="48" alt="TremTec Logo" />
